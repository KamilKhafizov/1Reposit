...
class Book:
    ...
    def __repr__(self):
        """
        Метод для представления книги в виде валидной строки для инициализации экземпляра.

        :return: Строка, например, "Book(id_=1, name='test_name_1', pages=200)"
        """
...
class Library:
    def __init__(self, books=None):
        ...
        :param books: Список книг (необязательный, по умолчанию None).
        """
        self.books = books or []
